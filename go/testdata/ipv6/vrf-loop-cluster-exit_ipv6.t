...
router:R@v1 = {
 ...
 interface:trans1 = { ip6 = ::a09:101; hardware = e1; }
 interface:trans2 = { ip6 = ::a09:201; hardware = e2; }
}

# Two transport networks creating a loop
network:trans1 = { ip6 = ::a09:100/120; }
network:trans2 = { ip6 = ::a09:200/120; }

# Firewall in VRF v1 - completes the loop
router:FW@v1 = {
 managed;
 model = IOS;
 interface:trans1 = { ip6 = ::a09:102; hardware = t1; }
 interface:trans2 = { ip6 = ::a09:202; hardware = t2; }
 interface:shared = { ip6 = ::a08:801; hardware = shared; }
}

# Shared network connects to VRF v2
network:shared = { ip6 = ::a08:800/120; }

# VRF v2 on same physical router R
router:R@v2 = {
 managed;
 model = IOS;
 interface:shared = { ip6 = ::a08:802; hardware = e3; }
 interface:n2 = { ip6 = ::a02:201; hardware = e4; }
}
